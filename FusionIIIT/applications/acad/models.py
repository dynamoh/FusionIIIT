...
class Student_acad(models.Model):
    id =  models.OneToOneField(ExtraInfo, on_delete=models.CASCADE, primary_key=True,related_name="Student_Info_Extra")
...
class Register(models.Model):
    ...
    curr_id = models.ForeignKey(CurriculumCourse, on_delete=models.CASCADE)
    year = models.IntegerField(default=(timezone.now().year))
    student_id = models.ForeignKey(Student_acad, on_delete=models.CASCADE)
...
class StudentRegistrationCheck(models.Model):
    student = models.ForeignKey(Student_acad, on_delete = models.CASCADE)
