...
from .models import BatchSemester,Course,CurriculumCourse,CurriculumInstructor,BtechCurriculum,Constants,MtechCurriculum,MtechSemester,Student_acad,Register,StudentRegistrationCheck,InitialRegistrations,FinalRegistrations
